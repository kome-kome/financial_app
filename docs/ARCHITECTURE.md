...
erDiagram
    ...
    split_adjustment_factors {
        ...
        string  kinds            "寄与イベントの種別（split / composite / reverse・昇順カンマ区切り）"
