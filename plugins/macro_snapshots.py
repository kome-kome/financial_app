...
# 46本は全て 2021-01（＝週次株価の開始月）から非 None で、strict / nan_ok / マクロ無しの
# 3条件でスナップショット母集団が完全一致する（47ヶ月・2021-08〜2025-06・111,210サンプル）。
# ＝**strict 制約は現在1行も落としておらず、学習窓を律速していない**。窓を決めているのは
# stock_price_weekly（2021-01-04〜・ラベル52週先で上限53ヶ月）と financial_records
# （period_end 2020-09〜・先頭6ヶ月を削る）というデータ履歴長で、マクロ既定の増減では伸びない
# （ADR-0016 §Consequences 追試・Issue #411）。かつてここに書かれていた「次の律速は
# コモディティ8系列（2020-07 開始）」は、その後の再収集で 8系列とも 2016-07 まで遡ったため解消済み。
